            ...
            <div className="row align-items-top">
                    ...
                    <div className="hero_left_side ">
                        ...
                        <div className="hero_btn d-flex ">
                            ...
                            <button className="btn btn_dark dark_btn">
                                <a className="clr_white" href="./portfolio.html">View Portfolio
                ...
                <div className="col-lg-6">
                    <div className="hero_right_side">
                        ...
                        <img className="right_element d-none d-lg-block" src="./assets/images/hi_jhon_right_background_img.png" alt=""/>
