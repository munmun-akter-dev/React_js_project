...
import pbimg from '../assets/images/primary_btn_img.png'
import alpic from '../assets/images/about_left_pic.png'
import ampic from '../assets/images/about_middle_pic.png'
import arupic from '../assets/images/about_right_upper_pic.png'
...
const AboutHero = () => {
    return (
        <div>
            <section className="about_hero_section" style={{ overflowX: "hidden" }}>
                <div className="container">
                    <div className="row ">
                        <div className="about_hero ">
                            <h2 className="about_white_heading" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                                data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-mirror="true"
                                data-aos-once="false">
                                Hi, I am
                            </h2>
                            <h2 className="about_clring_heading" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50"
                                data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-mirror="true"
                                data-aos-once="false">Jhon Smith</h2>


                            <p className="about_hero_content">
                                With 10 years experience as a professional Web developer,
                                1 have acquired <br className="d-none d-lg-block" /> the skills and knowledge necessary to make your
                                project a success. I enjoy <br className="d-none d-lg-block" /> every step of the design process,
                                from discussion and collaboration.
                            </p>


                            <ul className="about_hero_social_group d-flex justify-content-center gap-4 ">
                                <li>
                                    <a href="">

                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <path d="M8.67576 7.3349C8.67558 7.68851 8.53446 8.02755 8.28343 8.27746C8.03241 8.52737 7.69204 8.66767 7.33721 8.6675C6.98238 8.66732 6.64216 8.52668 6.39138 8.27652C6.14061 8.02636 5.99982 7.68717 6 7.33357C6.00018 6.97997 6.1413 6.64092 6.39233 6.39101C6.64336 6.1411 6.98372 6.0008 7.33855 6.00098C7.69338 6.00115 8.0336 6.14179 8.28438 6.39195C8.53515 6.64211 8.67594 6.9813 8.67576 7.3349ZM8.7159 9.65477H6.04014V18.001H8.7159V9.65477ZM12.9436 9.65477H10.2812V18.001H12.9168V13.6212C12.9168 11.1814 16.1077 10.9547 16.1077 13.6212V18.001H18.75V12.7146C18.75 8.6015 14.0273 8.75482 12.9168 10.7747L12.9436 9.65477Z" fill="white" />
                                        </svg>
                                    </a>
                                </li>
                            ...
                            <div className="about_img_group d-flex justify-content-center align-items-cente gap-4">

                                <div className="col-lg-3 pt-4 ">
                                    <img className="img-fluid " src={alpic} alt="" />
                                </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 ">
                                <div className="edu_exp_side">
                                    <h2 data-aos="fade-right" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1400"
                                    ...
                                    <ul>
                                        <li>
                                            <h3>STANFORD UNIVERSITY


                                            </h3>
                                            <p
                                                className="edu_exp_side_sub_heading d-flex justify-content-between align-items-end gap-4">
                                                Frontend Web Developer Degree <span>• 2016-2020</span></p>

                                            <div className="edu_exp_items">
                                        ...
                                        <li>
                                            ...
                                            <p
                                                className="edu_exp_side_sub_heading d-flex justify-content-between align-items-end gap-4">
                                                User Experience Master <span>• 2012-2016</span></p>
                                            <div className="edu_exp_items">
                                        ...
                                        <li>
                                            <h3>NEW YORK UNIVERSITY


                                            </h3>
                                            <p
                                                className="edu_exp_side_sub_heading d-flex justify-content-between align-items-end gap-4">
                                                Web Development Degree <span>• 2008-2012</span></p>
                                            <div className="edu_exp_items">
                            ...
                            <div className="col-md-6">
                                <div className="edu_exp_side">
                                    <h2 data-aos="fade-left" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1400"
                                        data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">
                                        Work Experience
                                    </h2>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p
                                                className="edu_exp_side_sub_heading d-flex justify-content-between align-items-end gap-4">
                                                Product Manager <span>• 2022</span></p>
                                            <div className="edu_exp_items">
                                        ...
                                        <li>
                                            ...
                                            <p
                                                className="edu_exp_side_sub_heading d-flex justify-content-between align-items-end gap-4">
                                                Visual Designer <span>• 2018</span></p>
                                            <div className="edu_exp_items">
